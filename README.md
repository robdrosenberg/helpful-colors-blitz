...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/helpful-colors-blitz
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/helpful-colors-blitz_test
```
